...
class ImageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.pages.admin.etablishment_images.index', compact('images'));
    }
    ...
    public function create()
    {
        ...
        return view('back.pages.admin.etablishment_images.create', compact('etablishments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.etablishment_images.index')->with('success', 'Image ajoutée avec succès.');
    }
    ...
    public function show($id)
    {
        ...
        return view('back.pages.admin.etablishment_images.show', compact('image'));
    }
    ...
    public function edit($id)
    {
        ...
        $etablishments = Etablishment::all();
        return view('back.pages.admin.etablishment_images.edit', compact('image', 'etablishments'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.etablishment_images.index')->with('success', 'Image mise à jour avec succès.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.etablishment_images.index')->with('success', 'Image supprimée avec succès.');
    }
}
