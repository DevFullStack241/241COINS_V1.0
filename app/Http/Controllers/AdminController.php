...
class AdminController extends Controller
{
    ...
    public function sendPasswordResetLink(Request $request)
    {
        ...
        if (sendEmail($mailConfig)) {
            session()->flash('success', 'Nous avons envoyé par e-mail le lien de réinitialisation de votre mot de passe.');
    ...
    public function resetPassword(Request $request, $token = null)
    {
        ...
        if (
            ...
            if ($diffMins > constDefaults::tokenExpiredMinutes) {
                //If token expired
                session()->flash('fail', 'Le jeton a expiré, demandez un autre lien de réinitialisation du mot de passe.');
                return redirect()->route('admin.forgot-password', ['token' => $token]);
            } else {
                return view('back.pages.admin.auth.reset-password')->with(['token' => $token]);
            }
        } else {
            session()->flash('fail', 'Jeton invalide !, demandez un autre lien de réinitialisation du mot de passe');
            return redirect()->route('admin.forgot-password', ['token' => $token]);
        }
    }
    ...
    public function resetPasswordHandler(Request $request)
    {
        ...
        return redirect()->route('admin.login')->with('success', 'Félicitation !, Votre mot de passe a été modifié. Utilisez un nouveau mot de passe pour vous connecter au système.');
    }
