    ...
    <div class="col-xl-12 col-lg-4 col-md-4 col-sm-12 mb-30">
        <div class="pd-20 card-box height-100-p">
            <div class="profile-photo">
                ...
                <img src="{{ $client->picture ?? asset('images/default-avatar.png') }}" alt="" class="avatar-photo">
                        ...
                        <div class="modal-content">
                            <div class="modal-body pd-5">
                                <div class="img-container">
                                    <img id="image" src="{{ $client->picture ?? asset('images/default-avatar.png') }}"
                                        alt="Picture">
                                </div>
                            </div>
            ...
            <div class="profile-info">
                <h5 class="mb-20 h5 text-blue">Information client</h5>
                <ul>
                    <li>
