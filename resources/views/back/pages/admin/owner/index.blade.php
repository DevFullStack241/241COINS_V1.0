...
@section('content')
    ...
    <div class="card-box pb-10">
        <div class="h5 pd-20 mb-0">Tous les propriétaires</div>
                                ...
                                <tr role="row" class="odd">
                                    <td class="table-plus sorting_1" tabindex="0">
                                        <div class="name-avatar d-flex align-items-center">
                                            ...
                                            <div class="txt">
                                                <div class="weight-600">{{ $owner->name }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td style="">{{ $owner->username }}</td>
                                    <td style="">{{ $owner->email }}</td>
                                    <td style="">{{ $owner->address }}</td>
                                    <td style="">{{ $owner->phone }}</td>
                                    <td style="">
                                        <span class="badge badge-pill" data-bgcolor="#e7ebf5" data-color="#265ed7"
                                            style="color: rgb(38, 94, 215); background-color: rgb(231, 235, 245);">{{ $owner->profession }}</span>
                                    </td>
                                    <td style="">
                                        <div class="table-actions d-flex align-items-center">
                                            <!-- Bouton Voir -->
                                            <a href="{{ route('admin.owner.show', $owner->id) }}" data-color="#265ed7"
